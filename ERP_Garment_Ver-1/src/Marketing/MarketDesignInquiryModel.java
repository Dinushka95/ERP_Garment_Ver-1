...
public class MarketDesignInquiryModel {
    ...
    public ResultSet SearchEID(String Key){
        return autoSqlQuery.executeAutoSearchAll("emp_table","emp_id",Key);
    }
    ...
    return AutoDB_Connect.DB_ResultSet = autoSqlQuery.executeAutoViewAll("emp_table");
    }
    
    public ResultSet SearchCustomerTName(String key){
    return AutoDB_Connect.DB_ResultSet = autoSqlQuery.executeAutoSearchAll("emp_table","f_name",key);
    }
    ...
    public ResultSet SearchCustomerName(String Key){
        ...
        try {
            ...
            Logger.getLogger(MarketDesignInquiryModel.class.getName()).log(Level.SEVERE, null, ex);
        }
